...
import { faCircleCheck, faCircleXmark, faPen, faPlus } from "@fortawesome/free-solid-svg-icons";
            ...
            <th className="border border-gray-300 p-4">Activo</th>
              ...
              <td className="border border-gray-300 p-4">
								<button
									...
									}-600 hover:text-${interest.active == true ? "green" : "red"}-800`}
									aria-label={`Toggle estado de interés ${interest.name}`}
								>
									<FontAwesomeIcon icon={interest.active == true ? faCircleCheck : faCircleXmark} />
								</button>
							</td>
						</tr>
					))}
