...
const OtherProfileView = () => {
  return (
    <div className="flex flex-col items-center p-6 bg-gray-100 max-w-screen max-h-screen">
      
      <div className="bg-white rounded-lg shadow-md p-6 w-full max-w-md mt-10">
       
        <h1 className="text-xl font-semibold text-center">Katy Swift</h1>
        ...
        <div className="flex flex-col items-center mt-4">
          ...
          <div className="mt-4 text-left text-sm text-gray-700 w-full">
            <p>Comunicadora Audiovisual</p>
            <p>Fotógrafa</p>
