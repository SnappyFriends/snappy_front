		...
		<div className="hidden lg:block relative">
			<div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
				<div className="relative w-full">
					...
					>
						<span className="text-gray-500 text-sm ml-2 mr-6">
					...
					{showDropdown && (
						<div className="absolute top-full left-0 w-fit max-h-60 mt-6 bg-white border border-gray-300 rounded-lg shadow-lg z-10 overflow-y-auto">
							<ul className="space-y-2 p-2 w-15 w-full">
								{interests.map((interest) => (
									<li key={interest.interest_id} className="w-full">
				...
				<button
					className=" md:w-auto h-8 px-1  bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-600 transition duration-300"
			...
			{searchQuery.length > 0 && (
				<div className="absolute mt-4 w-full md:w-3/5 bg-white rounded-b-lg max-h-40 p-2 overflow-y-auto">
